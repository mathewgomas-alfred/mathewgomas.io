...
Similarly, removing patterns can be done by pressing the :guilabel:`Delete resource` button. Krita will not delete the actual file then, but rather deactivate it, and thus not load it.
